...
export default class Footer extends Component {
  render() {
    return (
      <section
        className="cid-qAL8FfWGXu mbr-parallax-background"
        id="footer1-g"
        data-rv-view="249"
      >
        <div
          className="mbr-overlay"
          style={{ backgroundColor: 'rgb(60, 60, 60)', opacity: 0.7 }}
        ></div>
        <div className="container">
          <div className="media-container-row content text-white">
            ...
            {footerContent.content.map((widget, index) => (
              <div
                key={index}
                className="col-12 col-md-3 mbr-fonts-style display-7"
              >
                ...
                <div className="social-list align-right">
                  {socialLinks.icons.map((icon, index) => (
                    <div key={index} className="soc-item">
                      ...
                      >
                        <span
                          className={`mbr-iconfont mbr-iconfont-social socicon-${icon.icon} socicon`}
                          media-simple="true"
                        ></span>
                      </a>
                    </div>
