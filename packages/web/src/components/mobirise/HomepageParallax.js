          ...
          <div className="row justify-content-md-center">
            <div className="mbr-white col-md-10">
              ...
              <div className="mbr-section-btn">
                <Link to={buttons[1].link} spy smooth duration={1000} offset={buttons[1].linkOffset} className={`btn btn-md ${buttons[1].class} display-4`} href={`#${buttons[1].link}`}><span className={`${buttons[1].icon} mbr-iconfont mbr-iconfont-btn`}></span>{buttons[1].text}</Link>
                <Link to={buttons[2].link} spy smooth duration={1000} offset={buttons[2].linkOffset} className={`btn btn-md ${buttons[2].class} display-4`} href={`#${buttons[2].link}`}><span className={`${buttons[2].icon} mbr-iconfont mbr-iconfont-btn`}></span>{buttons[2].text}</Link>
              </div>
            </div>
          </div>
        </div>
        <div className="mbr-arrow hidden-sm-down" aria-hidden="true" style={{boxShadow: "0 0 10px white"}}>
          <Link to={arrowTakesWhere} spy smooth duration={1000} offset={-50} href={`#${arrowTakesWhere}`}>
