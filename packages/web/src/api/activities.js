...
export const activities = {
  ...
  activities: [
    ...
    },
    {
      ...
      title: <>Contact Form started 📝</>,
      body: <>Message me there! I'm Waiting 🙂</>,
    },
    {
      ...
      body: (
        <>
          <strong>
            I'm yet to create an interface to provide latest updates
          </strong>{' '}
          here in this section. Till the time, I'll be announcing things on
          Twitter. Just as I always do... 😉
        </>
      ),
    },
    {
      ...
      body: <>May this year bring the best to you and me as well&nbsp;😆</>,
    },
    {
